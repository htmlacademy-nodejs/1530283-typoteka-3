...
describe(`API returns categories`, () => {
  ...
  test(`3 categories found`, () => expect(response.body.length).toBe(3));

  test(`1st category should be correct`, () =>
    expect(response.body[0]).toBe(`Программирование`));

  test(`2nd category should be correct`, () =>
    expect(response.body[1]).toBe(`Кулинария`));

  test(`3rd category should be correct`, () =>
    expect(response.body[2]).toBe(`За жизнь`));
});
